...
function ResponsiveDashboard() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      {/* Sidebar */}
      <div className={`
        fixed lg:relative top-0 left-0 h-screen bg-white text-gray-800 z-50
      ...
      <div className="flex-1 min-h-screen">
        ...
        <div className="bg-white text-gray-800 px-4 lg:px-6 py-4 shadow-sm border-b border-gray-200 
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              onClick={() => setSidebarOpen(!sidebarOpen)}
              className="bg-transparent border-none text-gray-500 cursor-pointer p-2 rounded-lg 
                         transition-all duration-200 hover:bg-gray-100 hover:text-gray-800"
            >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 lg:gap-6">
                  {openComplaints.map((complaint) => (
                    <ComplaintCard 
                      ...
                      onChatClick={(complaint) => {
                        setSelectedChatComplaint(complaint);
...
const ComplaintCard = ({ complaint, onClick, variant = "pending", onChatClick }) => {
  const isResolved = variant === "resolved";
  const hasDepartmentAssigned = complaint.assignedDepartment; // Only show chat if there's a department assigned
  ...
  return (
    <div
      ...
      className={`
        ...
        ${isResolved ? 'border-l-4 border-l-green-500' : 'border-gray-200 hover:border-blue-300'}
      `}
    >
      {/* Card Header */}
      ...
      <div className="flex items-center justify-between pt-3 border-t border-gray-100">
        ...
        <div className="flex items-center gap-2">
          ...
          {hasDepartmentAssigned && !isResolved && (
            <button
...
// Form Modals would go here but are quite large, so I'll create them as separate components
